...
if (GameDefinition["Briefing"]["Active"] == true) then
	...
	GameDefinition["Map"]["Name"] = "Dunath Plains"
	...
	BundleAction("Scrolling Text", "Sandria Fields", "campaigns/human-tales/level02h.txt", nil, {"Briefing1", "Briefing2", "Briefing3", "Briefing4", "Briefing5", "Briefing6", "Briefing7", "Briefing8", "Briefing9"})
	--BundleAction("Chat", "Sandria Fields", "You made it, finally. I don't have time to explain the situation.", nil, {"Briefing1", "Briefing2", "Briefing3", "Briefing4", "Briefing5", "Briefing6"})

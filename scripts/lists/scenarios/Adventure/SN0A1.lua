...
elseif (GameDefinition["Briefing"]["Active"] == 3) then
	GameDefinition["Briefing"]["Active"] = 8
...
if (GameDefinition["Briefing"]["Active"] == 13) then
...
elseif (GameDefinition["Briefing"]["Active"] == 14) then
	BundleAction("Chat", "Sandria Fields", "This is my castle.")
...
if (GameDefinition["Briefing"]["Active"] == 8) then
	BundleAction("Choice", "Sandria Fields", "Any questions?")
...
elseif (GameDefinition["Briefing"]["Active"] == 10) then
	BundleAction("Choice", "Sandria Fields", "Good. You will report to Genesis Castle. Additional orders will be dispatched to you there.")
elseif (GameDefinition["Briefing"]["Active"] == 11) then
